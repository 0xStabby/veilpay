...
export function loadCommitments(
  mint: PublicKey,
  owner: PublicKey
): { commitments: bigint[]; complete: boolean } {
...
export function selectNotesForAmount(
  ...
  const available = listSpendableNotes(mint, owner).sort((a, b) =>
